...
from core.tokens.arthmetic import Addition, BinaryOperator, Division, Exponentiation, Multiplication, Subtraction
from core.tokens.boolean import EqualTo, GreaterOrEqualTo, GreaterThan, IfStatement, LessOrEqualTo, LessThan
...
class Parser():
    ...
    def parse(self):
        ...
        @self.pg.production('arthmetic_expression : arthmetic_expression multiplication term')
        @self.pg.production('arthmetic_expression : arthmetic_expression subtraction term')
        ...
        @self.pg.production('arthmetic_expression : arthmetic_expression exponentiation term')
        ...
        @self.pg.production('boolean_expression : arthmetic_expression equal_to arthmetic_expression')
        @self.pg.production('boolean_expression : arthmetic_expression less_than arthmetic_expression')
        @self.pg.production('boolean_expression : arthmetic_expression less_or_equal_to arthmetic_expression')
        @self.pg.production('boolean_expression : arthmetic_expression greater_or_equal_to arthmetic_expression')
        @self.pg.production('boolean_expression : arthmetic_expression greater_than arthmetic_expression')
        def boolean_expression(p):
            ...
            match operator:
                ...
                case _:
                    raise TypeError(f'Unkown operator for boolean expression: {operator}')
